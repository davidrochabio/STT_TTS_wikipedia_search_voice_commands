...
if __name__ == "__main__":
    ...
    while True:
        ...
        print('###################################################')
        print('')        
        frase = "Você disse: {}. Este termo está correto? Digite sua opção no console.".format(search)
        write_speak(engine,frase)
        print('')
        print('##################################################')
        print('')
        ...
        print('')
        print('-> Digite "não" para repetir o termo de busca')
        print('')
        ...
        if confirm == 'sair':
            ...
            try:
                ...
                print('##################################################')
                print('')
                frase = "Deseja continuar pesquisando? Digite sua opção no console."                
                write_speak(engine,frase)
                print('')
                print('##################################################')
                print('')
